...
String generateRandomString(int len) {
  ...
  Future<int> generarPdf (BuildContext context) async {
    ...
    try {
      ...
      final oooo = await getExternalStorageDirectories(type: StorageDirectory.documents);
  ...
  //   final file = File("${output.path}/example.pdf");
      ...
      final directorio2 = "${output2.path}/FACTURA_NUEVA.pdf";
      final directorio3 = "${oooo!.elementAt(0).path}/FACTURA_NUEVA.pdf";

      
      final directory1 = io.Directory(directorioFinal);
      final directory2 = io.Directory(output2.path);
      final directory3 = io.Directory(oooo.elementAt(0).path);
      ...
      if (!await directory2.exists()) {
        await directory3.create(recursive: true);
      }

      if (!await directory3.exists()) {
        await directory3.create(recursive: true);
      }
