...
class _FacturacionState extends State<Facturacion> {
                ...
                CircleAvatar(            
                  ...
                  child:provider.getPersona==null
                    ? TextButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>PersonaPage()));
                    }, child: const Text("Buscar. Click!"))
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Servicios", style: TextStyle(fontFamily: "Printer", fontSize: 30),
                    ),
                    buildItem(0,"Cable"),
                    Divider(),
                    ...
                    Divider(),
                    const Text(
                      "Meses", style: TextStyle(fontFamily: "Printer", fontSize: 30),
                    ),
                    Meses(),
                    buildListMeses(),
                    const Text(
                      "Monto", style: TextStyle(fontFamily: "Printer", fontSize: 30),
                    ),
                    buildInputFilter(),
                    InkWell(
                      onTap: (){              
                        enviarFactura(context);
                      },
                      child: Container(
                        height: 50,
                        decoration: BoxDecoration(
  ...
  void enviarFactura(BuildContext context){
    final cobro = checked[0]? "Cable": checked[1]? "Internet":null; 
