...
class _PersonaPageState extends State<PersonaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: IconButton(
        ...
        icon: Icon(Icons.arrow_back,size: 40,shadows: [Shadow(color: Colors.black,offset: Offset(1, 5),blurRadius: 5)],)
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            buildInputFilter(),
            buildSubtitle(),
            IconButton(onPressed: showBottomSheet, icon: const Icon(Icons.add_reaction_rounded,size:40, color: Colors.blueGrey,)),
            buildListPersons()
          ],
        ),
      ),
  ...
  Widget buildInputFilter(){
    return Container(      
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        boxShadow: const [
          BoxShadow(color: Colors.black,offset: Offset(1,-2),blurRadius: 1,)
        ],        
          ...
          Expanded(
            child: TextField(
              ...
              onChanged: (String? valor){
                ...
                final nuevaLista = personasAux.where((element) => element.nombre.toLowerCase().contains(valor!.toLowerCase()));
                setState(() {
  ...
  Widget buildSubtitle() {
    return Container(
      ...
      child: Text("Registrados", style: TextStyle(fontFamily: "printer"),),
    );  
  }
  ...
  void guardarPersona() async {
    Persona pers = Persona(nombre: nombreController.text, direccion: direccionController.text, id: int.parse(idController.text));
